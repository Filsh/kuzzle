...
module.exports = function AdminController (kuzzle) {
  ...
  this.getConfig = function (requestObject) {
    return kuzzle.pluginsManager.trigger('data:beforeConfig', requestObject)
      .then(newRequestObject => kuzzle.pluginsManager.trigger('data:afterConfig', new ResponseObject(newRequestObject, kuzzle.config)));
  };
